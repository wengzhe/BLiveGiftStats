...
class GiftStatsHandler(BaseHandler):
    ...
    async def _on_gift(self, client: BLiveClient, message: GiftMessage):
        ...
        self.db.run(GiftStatsTable.update_gift_message, room_id=client.room_id, message=message)
    ...
    async def _on_buy_guard(self, client: BLiveClient, message: GuardBuyMessage):
        ...
        self.db.run(GiftStatsTable.update_guard_message, room_id=client.room_id, message=message)
    ...
    async def _on_super_chat(self, client: BLiveClient, message: SuperChatMessage):
        ...
        self.db.run(GiftStatsTable.update_sc_message, room_id=client.room_id, message=message)
